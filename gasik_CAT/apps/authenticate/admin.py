...
from gasik_CAT.apps.kelola.models import Jurusan, HurufJawaban
from gasik_CAT.apps.profil.models import ProfilMahasiswa
...
admin.site.register(ProfilMahasiswa)
admin.site.register(Jurusan)
admin.site.register(HurufJawaban)